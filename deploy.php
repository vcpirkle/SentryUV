 ...
 * @var string
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', '99fa00ab-4887-41f7-8c72-1fd8863fd709');
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'git@github.com:vcpirkle/SentryUV.git');
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/tmp/sentryuv-php-git-deploy/');
...
$commands[] = sprintf(
	'rsync -rltgoDzvO %s %s %s %s'
	, TARGET_DIR
	, '/var/www/html/victorpirkle/sentryuv/'
	, (DELETE_FILES) ? '--delete-after' : ''
	, $exclude
);

...
class dbal
{
	...
	*/
	...
	public function createDbFailureException($sql = '', $table = null) {
		$error = $this->sql_error($sql);
		$message = $error['message'];
		if (isset($table)) $message = $message . ' (' . $table . ')';
		return new Exception('Error with database: ' . $message);
 	}
}
